...
export const StopPromotionsEventPattern = 'stop-promotions-message'
export const ResumeWhatsAppPromoEventPattern = 'resume-promotions-message'
export const ResumeWhatsAppUpdatesEventPattern = 'resume-updates-message'
...
export const WhatsappMessageStatusUpdateEventPattern = 'whatsapp-message-status-update'

// campaign update
export const CampaignLaunchEventPattern = 'campaign-launch-message'
export const CampaignMessageStatusUpdateEventPattern = 'campaign-message-update'
